...
def is_mel(name, email):
    ...
    >>> is_mel('Mel Melitpolski', 'anyemail@email.com')
    True

    >>> is_mel('Not the right name', 'mel@ubermelon.com')
    True
    """
...
def most_and_least_common_type(treats):
    """Given list of treats  dictionaries, return {most, least} common types.
    ...
    Test case for one type of treats

    >>> desserts = [{'type': 'dessert'}, {'type': 'dessert'}, {'type': 'dessert'}, {'type': 'dessert'}, {'type': 'dessert'}, {'type': 'dessert'}]
    >>> most_and_least_common_type(desserts)
    ('dessert', 'dessert')

    Test case in the case of a tie 

    >>> foods = [{'type': 'drinks'}, {'type': 'dessert'}, {'type': 'dessert'}, {'type': 'drinks'}, {'type': 'dessert'}, {'type': 'drinks'}]
    >>> most_and_least_common_type(foods)('dessert', 'dessert')
